...
In domain adaptation, when we consider the source model is the teacher and the predictions of the target data give by the source models as the privileged information,
